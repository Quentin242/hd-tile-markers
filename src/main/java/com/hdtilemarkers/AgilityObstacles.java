/*
 * Copied from RuneLite's Agility plugin (net.runelite.client.plugins.agility.Obstacles,
 * https://github.com/runelite/runelite, tag runelite-parent-1.12.39). Copyright (c) 2018, SomeoneWithAnInternetConnection,
 * BSD 2-Clause License; see META-INF/LICENSE-runelite and THIRD_PARTY_NOTICES.md.
 * Changes for HD Tile Markers: package and class name; the trap region list (used by the plugin itself) removed.
 */
...
/** The Agility plugin's obstacle categories, to apply its per-category options. */
final class AgilityObstacles
{
