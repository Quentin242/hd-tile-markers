...
Uses your existing Ground Markers, Object Markers and NPC Indicators settings. Also integrates with Better NPC Highlight, Tile Packs, Sailing, Stealing Artefacts, The Gauntlet, NPC Aggression Timer, Agility and Shortest Path. Keep the source plugins enabled; their saved settings are left unchanged.
